...
const LargePizza = () => {
  return (
    <>
      <div
        id="largepizza"
        className="h-[400px] bg-[url(../src/assets/images/png/tasty-bg-img.png)] bg-cover px-3 flex items-center"
      >
        <div className="max-w-[1194px] mx-auto w-full">
          <div className="flex max-sm:flex-wrap justify-center gap-5 lg:gap-[44px] items-center">
            <div className="md:max-w-[400px] lg:max-w-[597px]">
              ...
              <CustomBtn btnClass="!px-[32.7px] mt-3" btnText="Order Now" />
            </div>
